...
3. Run using this VM options: `-XX:MinHeapFreeRatio=10 -XX:MaxHeapFreeRatio=50 -XX:-ShrinkHeapInSteps -Xmx6g`
...
6. Click `Import` to load the dataset into memory. You will need about 6 GB of RAM to import.
7. It will take about 2-5 minutes for the entire import process to complete. The process is visible both visually in the browser and in the server console.
